...
log.info('Gatheting eos listing')
...
for product in products:
	...
	for listing in listings:
		...
		if listing not in parsed_eos_listing_products:
			...
			if eos_product_page not in all_eos_pages:
				all_eos_pages.append(eos_product_page)
...
log.info('PHASE 3 PARSING EOS DOCUMENTS')
for eos in all_eos_pages:
